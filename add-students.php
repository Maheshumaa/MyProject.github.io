                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Student Exam Details</h2>
...
<div class="col-sm-10">
<input type="number" name="emailid" class="form-control" id="email" required="required" autocomplete="off">
</div>
</div>
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Exam Date</label>
                                                        <div class="col-sm-10">
