                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        <li><a href="dashboard_result.php"><i class="fa fa-home"></i> Home</a></li>
...
<div class="col-sm-10">
<input type="number" name="rollid" class="form-control" id="rollid" value="<?php echo htmlentities($result->RollId)?>" maxlength="5" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="number" name="emailid" class="form-control" id="email" value="<?php echo htmlentities($result->StudentEmail)?>" required="required" autocomplete="off">
</div>
</div>
...
{
?>
<input type="radio" name="status" value="1" required="required" checked>Allow <input type="radio" name="status" value="0" required="required">Block 
<?php }?>
<?php  
if($stats=="0")
{
?>
<input type="radio" name="status" value="1" required="required" >Allow <input type="radio" name="status" value="0" required="required" checked>Block 
<?php }?>
