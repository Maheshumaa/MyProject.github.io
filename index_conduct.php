...
<body>
<?php
    require('includes_conduct/db.php');
    session_start();
    ...
    //Checking is user existing in the database or not
        ...
        if($rows==1){
            ...
            header("Location: dashboard_conduct.php"); // Redirect user to index.php
            }else{
                echo "<div class='form'><h3>Username/password is incorrect.</h3><br/>Click here to <a href='index_condcut.php'>Login</a></div>";
                }
    }else{
?>
...
<h1> <i class="fas fa-sign-in-alt">  Log In For Conducts Branch</i></h1>
</div>
</div>
</header>
...
<p>Not registered yet? <a style="color:blue;" href='registration_conduct.php'>Register Here</a></p>
</center>
<br /><br />
    </div>
    </div>
