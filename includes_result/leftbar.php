                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <a href="dashboard_result.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a>
...
<li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                         ...
                                         <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>DMC Generarion</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="result1.php"><i class="fa fa-bars"></i> <span>Result</span></a></li>
